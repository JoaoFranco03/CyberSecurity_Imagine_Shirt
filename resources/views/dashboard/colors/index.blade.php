        ...
        <div class="fixed inset-0 z-10 overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0" x>
                <div
                    ...
                    <form id="add_color_form" action="{{route('colors.store')}}" method="POST">
                        @csrf
                        <div class="">
                            <div class="mt-3 text-center sm:mt-0 sm:text-left">
                                <div>
                                    <label for="name"
                                        ...
                                        Name:</label>
                                    <input type="text" name="name" id="color_name"
                                ...
                                <div class="mt-4">
                                    <label for="code"
                                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color
                                        Code:</label>
                                    <input type="text" name="code" id="color_code"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                           required>
                                    @error('code')
                                    <div class="text-red-600 mt-1 text-md font-bold">
                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Colors</h1>
                            <p class="mt-2 text-sm text-gray-700 dark:text-gray-400">A list of all the Colors of the
                                Store.
                            </p>
                        </div>
                        <div class="mt-4 flex items-center space-x-2">
                            <form action="{{route('colors.index')}}" method="GET" id="filters_form">
                                <div class="flex w-full space-x-2">
                                    <div class="flex items-center w-80 my-4 border-r pr-2">
                                        ...
                                        <select type="text" id="table-search" name="sort" form="filters_form"
                                               ...
                                               <option value="Code_A_Z" @if($sort == "Code_A_Z")selected @endif>Code: A to Z</option>
                                               <option value="Code_Z_A" @if($sort == "Code_Z_A")selected @endif>Code: Z to A</option>
                                        </select>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="-my-2 -mx-4 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                    ...
                                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        @foreach ($colors as $color)
                                            <tr x-data="{ checked: false }"
                                                ...
                                                <td
                                                    class="whitespace-nowrap py-4 text-sm font-medium text-gray-900 dark:text-white">
                                                    <a class=" flex items-center" href="#">
                                                        <span
                                                            class="relative inline-flex rounded-lg h-10 aspect-1 border border-gray-300"
                                                ...
                                                <td
                                                    ...
                                                    <div class=" space-x-2 flex justify-end">
                                                        ...
                                                        <form action="{{route('colors.destroy', ['color' => $color])}}"
                                                              method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                ...
                                <div class="pt-14 mx-auto">
                                    {{ $colors->withQueryString()->links('pagination::tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
