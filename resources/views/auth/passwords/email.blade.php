...
<div class="flex h-screen">
    <div class="flex flex-1 flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <a href="{{route('login')}}" class="mb-8 hidden text-sm font-semibold text-blue-600 hover:text-blue-500 sm:block">
            <span aria-hidden="true"> &larr;</span> Go Back to Sign In
        </a>
        <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
                ...
                <h2 class="mt-6 text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Recover Your Password</h2>
            </div>
            ...
            <div class="mt-8">
                <div class="mt-6">
                  ...
                  __('Recover Your Password') }}</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="relative hidden w-0 flex-1 lg:block">
        <img class="absolute inset-0 h-full w-full object-cover" src="/img/store2.jpg" alt="">
    </div>
</div>
</body>
